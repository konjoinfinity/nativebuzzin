        ...
        return (
            <ScrollView>
                <View style={{ backgroundColor: "#e0f2f1", borderRadius: 15, margin: 10, padding: 10 }}>
                    ...
                    <TouchableOpacity style={styles.profilebutton} onPress={() => { ReactNativeHapticFeedback.trigger("selection", { enableVibrateFallback: true }) }}><Text style={{ textAlign: "center", color: "#ffffff" }}>Selection</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.profilebutton} onPress={() => { ReactNativeHapticFeedback.trigger("impactLight", { enableVibrateFallback: true }) }}><Text style={{ textAlign: "center", color: "#ffffff" }}>Impact Light</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.profilebutton} onPress={() => { ReactNativeHapticFeedback.trigger("impactMedium", { enableVibrateFallback: true }) }}><Text style={{ textAlign: "center", color: "#ffffff" }}>Impact Medium</Text></TouchableOpacity>
                    <TouchableOpacity style={styles.profilebutton} onPress={() => { ReactNativeHapticFeedback.trigger("impactHeavy", { enableVibrateFallback: true }) }}><Text style={{ textAlign: "center", color: "#ffffff" }}>Impact Heavy</Text></TouchableOpacity>
